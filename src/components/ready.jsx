    ...
    <section className='h-screen w-full   '>
      <div className=' w-[95%] mx-auto h-full flex '>
        <div  style={{backgroundImage:`url(${Happy})`}} className='w-[60%] gap-2  bg-center h-full flex flex-col justify-center'>
            {/* <h2 className='font-bold text-8xl '>Get In Touch With SkillSync</h2> */}
            <p className='text-2xl '>Have questions, feedback, or want to partner with us? We’d love to hear from you. Fill out the form below and our team will get back to you as soon as possible. Let’s build better learning journeys together</p>
        </div>
